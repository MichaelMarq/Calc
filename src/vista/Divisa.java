...
public class Divisa extends JFrame {
    ...
    private String moneda = "Estados Unidos - Dólar";
    private String moneda2 = "Estados Unidos - Dólar";
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tam > 0) {
                    ...
                    if (tam == 1) {
                        ...
                        if (cantidad.charAt(cantidad.length() - 1) == '.') {
                            punto = true;
                        }
    ...
    private void eventoC() {
        ...
        ActionListener evento = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                comboDivisa.setSelectedIndex(0);
                comboDivisa2.setSelectedIndex(0);
                moneda = "Estados Unidos - Dólar";
                moneda2 = "Estados Unidos - Dólar";
                cantidad = "";
                dinero = 0;
                cambio = 0;
                punto = true;
